...
export const projects: Project[] = [
  {
    ...
    summary: "An experimental intelligence engineering ecosystem for adaptable model training, evaluation, governance, and evidence-driven development across flexible compute environments.",
    ...
    highlights: [
      "Training and evaluation are treated as connected, evidence-producing work.",
      "Compute awareness informs planning across available environments.",
      "Public descriptions focus on research direction, not private datasets or protected implementations."
    ],
    flagship: true,
  ...
  },
  {
    ...
    summary: "AI-assisted tools and workflows for exploring game creation across multiple modern engines, with developer tooling that leaves creative direction in human hands.",
    ...
    highlights: [
      "Explores specialized tooling for game-development workflows.",
      "Designed as a research and development platform, not a promise of any particular shipped capability."
    ],
    accentColor: "#b487ff",
    visualStyle: "blocks",
    building: [
  ...
  },
  {
    ...
    summary: "An AI-assisted platform exploring writing, editing, organization, and publishing workflows — from draft through production, including multilingual direction and image-generation support.",
    ...
    highlights: [
      "Explores helpful organization and production workflows.",
      "Public materials describe active exploration rather than unsupported shipping claims."
    ],
    accentColor: "#d9813f",
  ...
  },
  {
    ...
    summary: "A private-development FDS platform for useful, accessible digital tools and infrastructure. Public description remains intentionally broad while the work is shaped and evaluated.",
  ...
  },
  {
    ...
    summary: "A community-focused discovery application for finding local farm stands, growers, markets, and locally available food. Built to connect people with nearby producers.",
    ...
    highlights: [
      "Designed around practical discovery of local food and growers.",
