...
export const founder: KaylaFounder = {
  ...
  publicBio: siteConfig.author + ' is building Forger Digital Solutions as an independent AI and software company. The work spans autonomous engineering, model research, game creation, publishing, civic information, local discovery, technician tools, and technology reuse.',
  ...
  fdsVision: 'Building an independent AI and software company where autonomous engineering, model learning, creative work, civic access, nearby discovery, and technician software can strengthen one another while remaining distinct products.',
